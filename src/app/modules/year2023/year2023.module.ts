...
@NgModule({
  declarations: [PageYear2023Component, SvgPrayKneesComponent, MainContent2023Component],
  imports: [CommonModule, SharedModule, Year2023RoutingModule, NgxCalendarModule],
